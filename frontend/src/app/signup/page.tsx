      ...
      <div className="w-full max-w-md space-y-6 relative z-10 animate-fade-in">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-400 font-medium">
            Create an account to start shortening and analyzing links
          </p>
        </div>
        ...
        <Card className="border-purple-950/40 bg-purple-950/15 backdrop-blur-xl shadow-2xl shadow-black/40 rounded-2xl overflow-hidden">
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardHeader className="space-y-1 pb-4">
              <CardTitle className="text-2xl font-bold tracking-tight text-white">Get Started</CardTitle>
              <CardDescription className="text-slate-400 text-sm">
                Register a new account to join ShortlyX
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-slate-350 text-xs font-bold tracking-wide uppercase">Full Name</Label>
                <Input
                  id="name"
                  type="text"
                ...
                />
                {errors.name && (
                  <p className="text-xs text-rose-600 font-medium mt-1 pl-1">{errors.name.message}</p>
                )}
              </div>
